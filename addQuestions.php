<?php
  if(isset($_POST['desc'])){
	...
	if($type == 'tf'){
		if((empty($_POST['desc'])) || (empty($_POST['answer1'])) || (empty($_POST['answer2'])) || (!$isCorrect)){
	...
	if($type == 'mc'){
		if((empty($_POST['desc'])) || (empty($_POST['answer1'])) || (empty($_POST['answer2'])) || (empty($_POST['answer3'])) || (empty($_POST['answer4'])) || (!$isCorrect)){
			echo "Sorry, All fields must be filled in to add a new question to the quiz. Please press back in your browser and try again.";
			exit();
		}
	}
	
	$lastId = update_quiz_answers($_SESSION['quiz_id'], $question, $type);
	...
	if($type == 'tf'){
		...
		if($isCorrect == "answer1"){
			...
			record_choice_correct($_SESSION['quiz_id'], $lastId, $answer1);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer2);
		...
		if($isCorrect == "answer2"){
			...
			record_choice_correct($_SESSION['quiz_id'], $lastId, $answer2);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer1);
	...
	if($type == 'mc'){
		...
		if($isCorrect == "answer1"){
			...
			record_choice_correct($_SESSION['quiz_id'], $lastId, $answer1);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer2);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer3);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer4);
			/* $sql2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysql_error());
			mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		...
		if($isCorrect == "answer3"){
			...
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer1);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer2);
			record_choice_correct($_SESSION['quiz_id'], $lastId, $answer3);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer4);
		...
		if($isCorrect == "answer4"){
			...
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer2);
			record_choice_incorrect($_SESSION['quiz_id'], $lastId, $answer3);
			record_choice_correct($_SESSION['quiz_id'], $lastId, $answer4);
...
if(isset($_POST['reset']) && $_POST['reset'] != ""){
	...
	$numLeft = reset_this_quiz($_SESSION['quiz_id']);
